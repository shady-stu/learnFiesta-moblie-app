...
export const profileStyles = StyleSheet.create({
    ...
    instructorTitle: { fontSize: 16, fontWeight: '700', color: '#333', marginBottom: 2 },
    instructorSubtitle: { fontSize: 12, color: '#666' },
    instructorButton: {
    ...
    instructorButtonText: { color: '#fff', fontWeight: '700' },
    statsRow: {
